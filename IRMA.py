    ...
    def aimFunc(self, pop): # objective function
        ...
        for (alpha,time_lag) in zip(alphas,time_lag):
            ...
            def load_rdata(file_path):
                ro.r['load'](file_path)  # Load the RData file into R's environment
                return ro.r['list2env'](ro.r['ls']())  # Extract all R variables as a dictionary
            ...
            TS_data = pd.read_csv("/home/mourinho/Desktop/probability models/project/GRNMOPT/IRAM/IRMAtrain.csv", sep='\t').values
            SS_data_1 = load_rdata("/home/mourinho/Desktop/probability models/project/GRNMOPT/IRAM/irma_on.RData")
            SS_data_2 = load_rdata("/home/mourinho/Desktop/probability models/project/GRNMOPT/IRAM/irma_off.RData")
            ...
            gold_edges = pd.read_csv("/home/mourinho/Desktop/probability models/project/GRNMOPT/IRAM/IRMA_Gold.RData", '\t', header=None)
        ...
        print("Objv1 shape:", np.array(Objv1).shape)
        print("Objv2 shape:", np.array(Objv2).shape)
        print("pop.Phen shape:", pop.Phen.shape)
