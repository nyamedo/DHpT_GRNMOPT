...
class MyProblem(ea.Problem):
    ...
    def aimFunc(self, pop): # objective function
        ...
        for (alpha,time_lag) in zip(alphas,time_lag):
            ...
            TS_data = pd.read_csv("/home/mourinho/Desktop/probability models/project/GRNMOPT/Ecoli/data.txt", sep='\t').values
            SS_data_1 = pd.read_csv("/home/mourinho/Desktop/probability models/project/GRNMOPT/Ecoli/coldstress.txt", sep='\t').values
            SS_data_2 = pd.read_csv("/home/mourinho/Desktop/probability models/project/GRNMOPT/Ecoli/heatstress.txt", sep='\t').values
            ...
            gold_edges = pd.read_csv("/home/mourinho/Desktop/probability models/project/GRNMOPT/Ecoli/DREAM5_NetworkInference_GoldStandard_Network3.tsv", '\t', header=None)
